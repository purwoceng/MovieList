import { AppBar, Toolbar, IconButton, Drawer, Button, Avatar, useMediaQuery, Box } from '@mui/material'
                    ...
                    <div>
                        {isAuthenticated ? (
                            ...
                            <Button color='inherit'
                                component={Link} to={`/profile/:id`} style={{ '&: hover': { color: 'white !important', textDecoration: 'none' } }} onClick={() => { }}>
                                {!isMobile && <>My Movies &nbsp;</>}
                                <Avatar
